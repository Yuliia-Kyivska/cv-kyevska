...
document.querySelector('.contacts-block').innerHTML += `<li><a href="tel:${data.adressphone}">${data.phone}</a></li>`
document.querySelector('.contacts-block').innerHTML += `<li><a href="mailto:${data.email}">${data.email}</a></li>`
document.querySelector('.contacts-block').innerHTML += `<li><a href="callto:${data.adresskype}">${data.skype}</a></li>`
document.querySelector('.contacts-block').innerHTML += `<li><a href="${data.addresslinkedin}">${data.linkedin}</a></li>`
